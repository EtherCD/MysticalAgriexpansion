package com.ethercd.mysticalagriexpansion.recipe;
...
public class ModRecipes {
    public static void init() {
        if (ModChecker.INSANIUM) {
            ...
            RecipeHelper.addShapedRecipe(new ItemStack(ModItems.INSANIUM_WATERING_CAN, 1, 0), "IF ", "ITI", " I ", 'I', ModParts.itemInsaniumIngot, 'T', ItemCrafting.INSANIUM_FERT_CORE.getItem(), 'F', ItemCrafting.INSANIUM_THEORETICAL_WATER.getItem());
        }
